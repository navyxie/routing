var Routing = {
    ...
    getCurrentPage: function (){
        var exists = DataStorage.get("routing");
        var result = null;
...
function onload_handler(fn, extraData){
    ...
    if(!DataStorage.get("routing")){
        data.isFirst = true;
        DataStorage.set('routing', [data]);
    }else{
        var exist = DataStorage.get("routing");
